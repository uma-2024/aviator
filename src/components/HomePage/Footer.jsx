      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          ...
          <nav className="footer-nav">
            ...
            <Link to="/live-rtp" className="footer-nav-link">LIVE RTP</Link>
            <Link to="/top-wins" className="footer-nav-link">TOP WINS</Link>
            <Link to="/faq" className="footer-nav-link">FAQ</Link>
            <Link to="/games" className="footer-nav-link">GAMES</Link>
          </nav>

          {/* Right - Social Media */}
          <div className="footer-social">
            <h3 className="footer-social-title">OUR SOCIAL MEDIA</h3>
            <div className="footer-social-icons">
              ...
              <Link to="#" className="footer-social-icon" aria-label="YouTube">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </Link>
              <Link to="#" className="footer-social-icon" aria-label="Twitter/X">
                <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <Link to="#" className="footer-social-icon" aria-label="Facebook">
                <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-bottom">
          ...
          {/* Right - Copyright and Legal Links */}
          <div className="footer-legal">
            <p className="footer-copyright">
              © 2026 All Rights Reserved. BGaming is a registered trademark.
            </p>
